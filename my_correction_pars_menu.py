...
class CorrectionParsMenu(wx.Menu):
    def __init__(self, parent):
        ...
        self.addRegSubmenu_PenSecDerSplineItem = addRegSubmenu.AppendCheckItem(-1,
                                                                               '&spline with penalized second derivative')
...
class LowessDialog(wx.Dialog):
    def __init__(self, updatedSettings):
        ...
        # get the settings
        isOverfitProof = {'True': True, 'False': False}[
            updatedSettings['refiningPars']['otherParams']['use overfit proof mode']]
        numPartForOverfitProofMode = updatedSettings['refiningPars']['otherParams'][
            'number of splits for overfit proof mode']
...
class RSplineDialog(wx.Dialog):
    def __init__(self, updatedSettings):
        ...
        numSparOptimSteps = updatedSettings['refiningPars']['regressionSettings']['R_runmed_spline'][
            'spar steps number']
...
class SseSplineDialog(wx.Dialog):
    def __init__(self, updatedSettings):
        ...
        sseLog10MultStr = updatedSettings['refiningPars']['regressionSettings']['numpy_runmed_spline'][
            'sse smooth log10 range']
