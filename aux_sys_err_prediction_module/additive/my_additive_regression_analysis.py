...
def do_additive_regression_analysis(Controller, xTandemInput, dtaInput):
    ...
    # isOverfitProofMode??
    isOverfitProofMode = {'True': True, 'False': False}[
    ...
    while True:
        ...
        for key in parSet.keys():
            ...
            logFh.flush()
            resultVals = do_1D_regression_analysis(ARG3,
                                                   Controller)  # ARG3 is split into K pieces if overfit proof mode is enabled
