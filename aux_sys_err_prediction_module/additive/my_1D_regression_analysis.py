from R_runmed_spline.my_R_runmed_spline_analysis import R_runmed_spline_MAIN
from numpy_runmed_lowess.my_numpy_runmed_lowess_analysis import runmed_lowess_MAIN
from numpy_runmed_spline.my_numpy_runmed_spline_analysis import runmed_spline_MAIN
