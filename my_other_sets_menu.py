...
class CleavageRuleEntry(XtandemSetsDialog):
    def __init__(self, parent):
        ...
        # text box
        self.cleavageSpecificityEntry  = wx.TextCtrl( self.parent, -1, cleavageSpecificity, validator = CleavageSpecificityFormatValidator())
        cleavageSpecificityTitle = wx.StaticText( self.parent, -1, 'Cleavage Specificity:', size = (100,-1), style=wx.ALIGN_RIGHT)
